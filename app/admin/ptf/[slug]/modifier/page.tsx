...
export default function EditPTFPage() {
  ...
  const [ptf, setPtf] = useState<IPTF | null>(null);
  ...
  useEffect(() => {
    const loadPTF = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error("PTF non trouvé");
        }
        ...
        // Set domaines
        if (data.domaines_list && Array.isArray(data.domaines_list)) {
          setDomaines(data.domaines_list);
        }
      } catch (err: any) {
  ...
  const onSubmit = async (data: PtfFormData) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.detail?.errors?.[0]?.message || "Erreur lors de la mise à jour du PTF");
      }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Modifiez les informations de {ptf?.name}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                  {thumbnailPreview ? (
                    <div className="relative">
                      ...
                      <label className="mt-2 block cursor-pointer text-sm text-[#E05017] hover:underline">
                        Changer l'image
                        <input
                          type="file"
                          accept="image/*"
          ...
          <div className="flex gap-4">
            ...
            >
              {isSubmitting ? "Mise à jour en cours..." : "Mettre à jour le PTF"}
            </button>
            <Link
              href="/admin/ptf"
