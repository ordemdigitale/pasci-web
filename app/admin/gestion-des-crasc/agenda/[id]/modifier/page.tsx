...
import { fetchAllCrasc, updateEvenement } from "@/lib/fetch-crasc";
...
export default function ModifierEvenementPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/api/v1/crasc/evenement/${id}`, {
      ...
      .then((data) => {
        setForm({
          ...
          lieu: data.lieu || "",
          crasc_id: data.crasc_id ? String(data.crasc_id) : "",
        });
      })
      ...
      <div className="bg-gradient-to-r from-[#2A591D] to-[#3d7a28] rounded-2xl p-8 mb-8 text-white shadow-xl">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-white/80 mt-1">Modifiez les informations de l&apos;événement</p>
          </div>
        </div>
        <Link
